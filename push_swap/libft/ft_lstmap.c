...
/* Iterates the list ‘lst’ and applies the function to the value of all nodes.
...
/* void *iterate(void *value)
{
    int *num = (int *)value;
    return (num);
}
void del_int(void *value)
{
    free(value);
} */
...
int main()
{
    ...
    t_list *elem1 = ft_lstnew(&value1);
    t_list *elem2 = ft_lstnew(&value2);
    t_list *elem3 = ft_lstnew(&value3);
